...
Report bugs at https://github.com/mabuchilab/qnet_qsd/issues.
...
QNET-QSD could always use more documentation, whether as part of the
official QNET-QSD docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/mabuchilab/qnet_qsd/issues.
...
Ready to contribute? Follow `Aaron Meurer's Git Workflow Notes`_ (with ``mabuchilab/qnet_qsd`` instead of ``sympy/sympy``)

In short,

1. Clone the repository from ``git@github.com:mabuchilab/qnet_qsd.git``
...
Python versions.
You still can (and should) look at https://travis-ci.org/mabuchilab/qnet_qsd/ to check that your commits pass all tests.
...
3. Check https://travis-ci.org/mabuchilab/qnet_qsd/pull_requests
