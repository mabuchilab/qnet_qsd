...
from qnet.algebra import (
    LocalSpace, LocalSigma, Destroy, identity_matrix, SLH, BasisKet)
from qnet.convert.to_qutip import SLH_to_qutip

from qnet_qsd import QSDCodeGen, _cmd_list_to_str
...
def test_driven_tls(datadir):
    ...
    pop0_expect, pop1_expect = np.genfromtxt(
        datfile, unpack=True, usecols=(1, 2))
